...
namespace Serial_ESCPOS
{
    public partial class Form1 : Form
    {
        ...
        {
            ipWrite("\n3.1 <GS ( L>方式,定义指定索引的位图到NV存储中!\n");
            textBox1.Text = "定义指定索引的位图到NV存储中!\r\n";
        ...
        private void button11_Click(object sender, EventArgs e)
        {
            ...
            ipWrite("\n3.3 <GS ( L>删除索引<" + comboBox4.Text + ">对应的BMP!\n\n");
