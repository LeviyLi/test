...
namespace Serial_ESCPOS
{
    public partial class Form1 : Form
    {
        ...
        {
            this.textBox1.Text = "读取计数器: " + comboBox1.Text + "!\r\n";
            ...
            else if (comboBox1.Text == "进纸的行数(更换)")
            {
                readCounter[4] = (byte)'\x16';
            }
            ...
            ipWrite("3.2 读取计数器: " + comboBox1.Text + "!\n\n");
        }
        ...
        {
            this.textBox1.Text = "读取累计值: " + comboBox1.Text + "!\r\n";
            ...
            ipWrite(readCounter, 0, readCounter.Length);
            ipWrite("3.1 读取累计值: " + comboBox1.Text + "!\n\n");
        }
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            // Enter user setting mode, "GS ( E" <Function 1>
            byte[] setBegin = new byte[] { 0x1D, 0x28, 0x45, 0x03, 0x00, 0x01, 0x49, 0x4E };
            ipWrite(setBegin, 0, setBegin.Length);

            // Set printer speed
            byte[] setSpeed = new byte[] { 0x1D, 0x28, 0x45, 0x04, 0x00, 0x05, 0x06, 0x09, 0x00};
            setSpeed[7] = (byte)Int16.Parse(comboBox2.Text);          
            ...
            MessageBox.Show("网口打印机需要复位，自动断开链接，所以需要手动重新打开该端口！");
        }
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            // Read printer baud, "GS ( E" <Function 12>
        ...
        private void button8_Click(object sender, EventArgs e)
        {
            ...
            // Set printer speed, GS ( K
            byte[] setSpeed = new byte[] { 0x1D, 0x28, 0x4B, 0x02, 0x00, 0x32, 0x00 };
            setSpeed[6] = (byte)Int16.Parse(comboBox4.Text);
            ipWrite(setSpeed, 0, setSpeed.Length);
        ...
        {
            this.textBox1.Text = "测试设置后的速度快慢!\r\n";

            ipWrite("2.2 测试设置后的速度快慢!\n测试设置后的速度快慢!\n"
                            + "测试设置后的速度快慢!\n测试设置后的速度快慢!\n"
                            + "测试设置后的速度快慢!\n测试设置后的速度快慢!\n\n");
        }
